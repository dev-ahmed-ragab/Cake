...
const page = () => {
  return (
    <section className="overflow-hidden h-[150vh] bg-fixed bg-[url(https://websitedemos.net/fiona-patisserie-04/wp-content/uploads/sites/1136/2022/11/bg-03.jpg)] bg-cover bg-top bg-no-repeat">
